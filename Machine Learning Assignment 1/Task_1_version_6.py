...
"""
    ...
    rmsetrain = np.zeros((12,1))
    rmsetest = np.zeros((12,1))
    ...
    plt.figure();
    plt.semilogy(range(1,13), rmsetrain)
    plt.semilogy(range(1,13), rmsetest)
    plt.legend(('RMSE Train', 'RMSE Test'), loc = 'upper right')
